    ...
    <div class="login-box-body">
        ...
        <form action="/login" method="post">
            <div class="form-group has-feedback">
                <input id="loginId" name="loginId" type="text" class="form-control" placeholder="用户名" value="${loginDTO.loginId}">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>

            <div class="form-group has-feedback">
                <input id="loginPwd" name="loginPwd" type="password" class="form-control" placeholder="密码" value="${loginDTO.loginPwd}">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox" id="isRemember" name="isRemember" ${"on" eq loginDTO.isRemember? "checked" : ""} > 记住我
                        </label>
                    </div>
              </div>
                <!-- /.col -->
