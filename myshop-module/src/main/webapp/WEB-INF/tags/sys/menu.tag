...
<%@attribute name="parentTitle" required="false" description="父级菜单标题" %>
<%@attribute name="subTitle" required="false" description="子集菜单标题" %>
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="/product.do?method=productslist"><i class="fa fa-circle-o"></i> 商品列表</a></li>
                </ul>
            </li>
        </ul>
    </section>
